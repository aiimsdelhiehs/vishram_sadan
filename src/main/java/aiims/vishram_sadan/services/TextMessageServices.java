...
public class TextMessageServices {
	...
	public void sendMessage(String mobileNo, String message) throws Exception {
		 try {
	          if(!isTextmessageActive) {
	        	  System.out.println("message to  "+mobileNo+": "+message);
	...
	/*
	 * public CustomResponse testTextMessageService() throws Exception { try {
	 * sendMessage(superAdminUsername,"Text Message services working fine!"); return
	 * new CustomResponse("Message service working fine!"); } catch (Exception e) {
	 * throw new Exception("Message service not working fine!"); } }
	 */
}
