...
<body class="d-flex flex-column h-100 bg-light " ng-app="App"
	ng-controller="BookingListController">
	<header>
	...
	<div class="container-fluid">
		<div class="card card-shadow p-3">
			<div class="card-header">
				<h4 class="mb-0">All Booking Request List</h4>
			</div>
			<div class="card-body">
				<div class="row mb-3">
					<div class="col-lg-12">
						<div class="col-lg-12">
							<ul class="nav nav-tabs" id="myTicketTab" role="tablist">
								<li class="nav-item" role="presentation">
									<button class="nav-link active" id="my-confirm-tab" data-bs-toggle="tab" data-bs-target="#confirm-tab" type="button" role="tab" aria-controls="confirm-tab" aria-selected="true">
										<i class="fas fa-envelope-open"></i> Confirm Requests
									</button>
								</li>
								<li class="nav-item" role="presentation">
									<button class="nav-link" id="my-close-tab" data-bs-toggle="tab" data-bs-target="#close-tab" type="button" role="tab" aria-controls="close-tab" aria-selected="false">
										<i class="fas fa-envelope"></i> Close Requests
									</button>
								</li>
							</ul>
							<div class="tab-content" id="myTicketTabContent">
								<div class="tab-pane p-3 fade show active" id="confirm-tab" role="tabpanel" aria-labelledby="my-confirm-tab">
									<div class="row mb-3">
										<div class="col-lg-12 table-responsive">
												...
												<table id="myTable" class="w-100 display">
													...
													<tbody>
														<tr ng-class="{'highlight': shouldHighlight(row.bookings)}" ng-repeat="row in filteredData">
															<td>{{ row.issuedOn.split('T')[0]}}</td>
															<td >{{ row.requestId }}</td>
								...
								<div class="tab-pane p-3 fade" id="close-tab" role="tabpanel" aria-labelledby="my-close-tab">
									<div class="row mb-3">
										<div class="col-lg-12 table-responsive">
												<table id="myTableClose" class="display">
													<thead>
														<tr>
															<th>Request</th>
															<th>UHID</th>
