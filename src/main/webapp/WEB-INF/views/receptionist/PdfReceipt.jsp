						...
						<div  class="col-lg-8"id="paymentReceipt">
							...
							<div >
								<div class="row" id="below">
									<div class="col">
										<h5 class="text">
										रसीद सं./Receipt No: <b><i>{{pdfData.bookings[0].paymentHistory[0].txnId}}</i></b>
											
										</h5>
									</div>
									<div class="col text-end"><h5 class="text-end">
											बुकिंग संदर्भ संख्या/Booking reference no: <b><i>{{pdfData.requestId}}</i></b>
										</h5></div>
								</div>
									<div class="row" >
									<div class="col">
										<h5 class="text">
											रसीद का प्रकार/Receipt Type: {{pdfData.bookings[0].paymentHistory[0].receiptType}}</i></b>
										</h5>
									</div>
								...
								<table class="table payment-receipt">
									<tbody>
										...
										<tr>
											<th>नाम/Name</th>
											<td>{{pdfData.patient.fullname}}</td>
											<th>UHID</th>
											<td class="text-end">{{pdfData.patient.uhid}}</td>
											<th>Contact No.</th>
											<td>{{pdfData.patient.contactNo}}</td>
											<th>पता/Address</th>
											<td class="text-end">{{pdfData.patient.address}}</td>
										</tr>
									</tbody>
								</table>
								...
								<table class="table payment-receipt">
									<tbody>
										...
										<tr ng-repeat="booking in pdfData.bookings">
										...
										<tr>
											<th colspan="3"></th>
											<th>Total</th>
											<th>{{getTotalBookingAmount(pdfData.bookings)}}</th>
										</tr>
									</tbody>
								</table>
								...
								<div class="row py-3">
								<div class="col text"><h6 class="text">
